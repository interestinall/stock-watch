...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "stockwatch" because\n';
  ...
  $wnd.__gwt_activeModules['stockwatch'] = {
    'moduleName' : 'stockwatch',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/stockwatch.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['stockwatch'].superdevmode = true;

  var expectedSuffix = '/stockwatch.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + stockwatch + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:stockwatch';
  var devModeSessionKey = '__gwtDevModeSession:stockwatch';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/stockwatch/stockwatch.nocache.js';
  ...
  $wnd.__gwt_activeModules['stockwatch'].canRedirect = true;
  $wnd.__gwt_activeModules['stockwatch'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/stockwatch?user.agent=' + ua + '&_callback=' + callback;
